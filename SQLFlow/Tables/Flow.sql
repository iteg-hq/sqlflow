CREATE TABLE internal.Flow (
  ...
  , CONSTRAINT FK_Flow_FlowType FOREIGN KEY (TypeCode) REFERENCES internal.FlowType (TypeCode)
  , CONSTRAINT FK_Flow_FlowStatus FOREIGN KEY (TypeCode, StatusCode) REFERENCES internal.FlowStatus (TypeCode, StatusCode)
)
